...
<body background="../asset/images/background.jpg">
	...
	<div class="lefthandside">
		...
		<h1>Recommended hotels:</h1>
			<div class="bleft">
				<a href="booking.php"><img class="boxpic" src="../asset/images/hotel1.jpg" alt="hotel room"></a>
				<h3>Hotel name</h3>
			...
			<div class="bright">
				<a href="booking.php"><img class="boxpic" src="../asset/images/hotel2.jpg" alt="hotel room"></a>
				<h3>Hotel name</h3>
				<p>ti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum </p>
			</div>
				<div class="bleft">
				<a href="booking.php"><img class="boxpic" src="../asset/images/hotel3.jpg" alt="hotel room"></a>
				<h3>Hotel name</h3>
				<p>ti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum </p>
			</div>
			<div class="bright">
				<a href="booking.php"><img class="boxpic" src="../asset/images/hotel4.jpg" alt="hotel room"></a>
				<h3>Hotel name</h3>
				<p>ti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum </p>
			</div>
		</div>
