...
<body background="../asset/images/background.jpg">
	...
	<div class="lefthandside">
		...
		<h1> Your booking options:</h1>
		<br>
      <h2>New bookings:</h2>
      <br>
			<div class="bookingoption">
				<a href="display.php"><img src="../asset/images/display.png"></a>
			</div>
			<div class="bookingoption">
				<a href="book.php"><img src="../asset/images/book.png"></a>
			</div>
			<div class="bookingoption">
				<a href="search.php"><img src="../asset/images/search.png"></a>
			</div>
      <h2>Existing bookings:</h2>
      <br>
      <div class="bookingoption">
        <a href="checkbooking.php"><img src="../asset/images/booked.png"></a>
      </div>
      <div class="bookingoption">
        <a href="deletewarning.php"><img src="../asset/images/cancel.png"></a>
      </div>
      <br>
		</div>
	</div>
