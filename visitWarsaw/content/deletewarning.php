...
<body background="../asset/images/background.jpg">
	...
	<div class="lefthandside">
      ...
      <h2>Are you sure you want to delete your bookings?</h2><br>
      <h3>This is permanent and cannot be reversed.</h3>
      <br>
      <br>
      <h2><a href="delete.php">Yes</a> - I'd like to cancel my bookings.<h3>
      <br>
      <br>
      <h2><a href="booking.php">No</a> - Go back to booking menu.</h2>
      <br />
